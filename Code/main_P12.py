...
# ------------------------------Supporting .py Files------------------------------
from data import P12data
from LSTMCell_P12 import LSTMCell
...
if __name__ == '__main__':
    ...
    data_name = "P12" # Keep this as data name for P12.
    number_features = 37 # Number of features in the P12 dataset
    ...
    dataset = data_name
    to_predict = "mortality" # We predict mortality

    print(batch_size, epochs, load_all, num_of_instances, cuda)

    # ------------------------------Result Address------------------------------
    path_to_result = __file__ + '/Results/P12/'
    ...
    trainset = P12data(config_dir = configdir,
                                name = 'train', 
                                device = device,
    ...
    valset = P12data(config_dir = configdir,
                                name = 'val', 
                                device = device,
                                num_of_instances = num_of_instances,
                                normalize_data = normalize_data,
    ...
    for e in range(epochs):
        ...
        print("Time taken to run this epoch: ", epoch_time[e])
